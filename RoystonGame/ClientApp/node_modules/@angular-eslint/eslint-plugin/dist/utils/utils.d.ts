...
export declare const getSymbolName: (expression: TSESTree.ExpressionWithTypeArguments) => string;
export declare const getDeclaredInterfaces: (node: TSESTree.ClassDeclaration) => TSESTree.ExpressionWithTypeArguments[];
...
export declare const getDecoratorProperty: (decorator: TSESTree.Decorator, name: string) => TSESTree.PropertyComputedName | TSESTree.PropertyNonComputedName | undefined;
export declare const getDecoratorPropertyValue: (decorator: TSESTree.Decorator, name: string) => TSESTree.ArrayExpression | TSESTree.ArrayPattern | TSESTree.ArrowFunctionExpression | TSESTree.AssignmentExpression | TSESTree.AwaitExpression | TSESTree.BigIntLiteral | TSESTree.BinaryExpression | TSESTree.CallExpression | TSESTree.ClassDeclaration | TSESTree.ClassExpression | TSESTree.ConditionalExpression | TSESTree.FunctionExpression | TSESTree.Identifier | TSESTree.Import | TSESTree.JSXClosingElement | TSESTree.JSXClosingFragment | TSESTree.JSXElement | TSESTree.JSXExpressionContainer | TSESTree.JSXFragment | TSESTree.JSXOpeningElement | TSESTree.JSXOpeningFragment | TSESTree.JSXSpreadChild | TSESTree.BooleanLiteral | TSESTree.NumberLiteral | TSESTree.NullLiteral | TSESTree.RegExpLiteral | TSESTree.StringLiteral | TSESTree.LogicalExpression | TSESTree.MemberExpressionComputedName | TSESTree.MemberExpressionNonComputedName | TSESTree.MetaProperty | TSESTree.NewExpression | TSESTree.ObjectExpression | TSESTree.ObjectPattern | TSESTree.OptionalCallExpression | TSESTree.OptionalMemberExpressionComputedName | TSESTree.OptionalMemberExpressionNonComputedName | TSESTree.RestElement | TSESTree.SequenceExpression | TSESTree.SpreadElement | TSESTree.Super | TSESTree.TaggedTemplateExpression | TSESTree.TemplateLiteral | TSESTree.ThisExpression | TSESTree.TSAsExpression | TSESTree.TSNonNullExpression | TSESTree.TSNullKeyword | TSESTree.TSTypeAssertion | TSESTree.UpdateExpression | TSESTree.UnaryExpression | TSESTree.YieldExpression | undefined;
