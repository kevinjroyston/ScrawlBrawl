...
namespace Backend.APIs.DataModels.UnityObjects
{
    public class Legacy_UnityView
    {
        ...
        public Legacy_UnityView(Lobby lobby)
        {
            this.Lobby = lobby;
            if(lobby != null)
            {
        ...
        [Newtonsoft.Json.JsonIgnore]
        [System.Text.Json.Serialization.JsonIgnore]
        public IAccessor<Legacy_UnityViewOptions> Options { private get; set; }
        public Legacy_UnityViewOptions _Options { get => Options?.Value; }
        ...
        [Newtonsoft.Json.JsonIgnore]
        [System.Text.Json.Serialization.JsonIgnore]
        public IAccessor<IReadOnlyList<Legacy_UnityImage>> UnityImages { private get; set; }
        public IReadOnlyList<Legacy_UnityImage> _UnityImages { get => UnityImages?.Value; }
