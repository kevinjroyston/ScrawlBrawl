...
using ValidationResult = Backend.GameInfrastructure.DataModels.States.UserStates.UserState.CleanUserFormInputResult;
using Backend.APIs.Helpers.Validation;

namespace BackendTests.TV.DataModels.States.UserStates
{
    [TestClass]
