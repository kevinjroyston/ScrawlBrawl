...
namespace RoystonGame.TV.GameModes.BriansGames.BodyBuilder.GameStates
{
    public class DisplayPeople_GS : GameState
    {
        ...
        public DisplayPeople_GS(Lobby lobby, BodyBuilderConstants.DisplayTypes displayType, List<Setup_Person> peopleList, Action<User, UserStateResult, UserFormSubmission> outlet = null) : base(lobby, outlet)
        {
