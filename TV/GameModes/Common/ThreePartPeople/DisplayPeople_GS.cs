...
namespace RoystonGame.TV.GameModes.BriansGames.Common.ThreePartPeople
{
    public class DisplayPeople_GS : GameState
    {
        ...
        public DisplayPeople_GS(Lobby lobby, string title, List<Person> peopleList, Action<User, UserStateResult, UserFormSubmission> outlet = null) : base(lobby, outlet)
        {
            ...
            if (displayType == BattleReadyConstants.DisplayTypes.PlayerHands)
            {
            ...
            else if (displayType == BattleReadyConstants.DisplayTypes.OriginalPeople)
            {
